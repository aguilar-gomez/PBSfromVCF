...
#Convert 1 to .999
persitefst$WEIR_AND_COCKERHAM_FST.1[persitefst$WEIR_AND_COCKERHAM_FST.1==1]<-.999
persitefst$WEIR_AND_COCKERHAM_FST.2[persitefst$WEIR_AND_COCKERHAM_FST.2==1]<-.999
persitefst$WEIR_AND_COCKERHAM_FST[persitefst$WEIR_AND_COCKERHAM_FST==1]<-.999
